...
public class ThymeleafController {
	...
	public ModelAndView index() {
		...
		view.addObject("desc", "欢迎进入gzz-web 系统");
		Author author = new Author();
		author.setAge(22);
		author.setEmail("38967098@qq.com");
		author.setName("高振中");
	...
	public String index1(HttpServletRequest request) {
		...
		request.setAttribute("desc", "欢迎进入gzz-web 系统");
		Author author = new Author();
		author.setAge(22);
	...
	public String index3(Map<String, Object> map) {
		// TODO 与上面的写法不同，但是结果一致。
		// 设置属性
		map.put("title", "我的第一个WEB页面");
		map.put("desc", "欢迎进入gzz-web 系统");
		Author author = new Author();
		author.setAge(22);
		author.setEmail("38967098@qq.com");
		author.setName("唐亚峰");
