...
public class AuthRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		// TODO 如果使用 HashedCredentialsMatcher 这里认证方式就要改一下 SimpleAuthenticationInfo
		// authenticationInfo = new SimpleAuthenticationInfo(principal, "密码",
		// ByteSource.Util.bytes("密码盐"), getName());
